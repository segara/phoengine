...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" show-ref "v2.0.4"
  WORKING_DIRECTORY "E:/git/phoengine/phoengine/OpenglProjDay3/build/fetch_contents/glad-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'E:/git/phoengine/phoengine/OpenglProjDay3/build/fetch_contents/glad-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'E:/git/phoengine/phoengine/OpenglProjDay3/build/fetch_contents/glad-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
